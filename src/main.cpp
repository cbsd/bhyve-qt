...
int main(int argc, char *argv[])
{
    ...
    qtemuApp.setApplicationName("Bhyve-Qt");
    qtemuApp.setApplicationVersion("2.2");
    qtemuApp.setOrganizationName("Bhyve-Qt");
    qtemuApp.setOrganizationDomain("https://github.com/cbsd");

    putenv("inter=0");
    putenv("NOCOLOR=1");

    std::cout << QString("Bhyve-Qt v%1 # Bhyve-Qt Developers")
